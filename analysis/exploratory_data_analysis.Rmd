...
shs_responses %>% 
  count(year)
```
- looks like greenspace questions were not asked in 2017 or 2018
...
shs_responses %>% 
  ...
  count(year)
```
- volunteering was left out of 2012 survey
...
- `highest_education_level` has more of an unstructered nature to NAs
